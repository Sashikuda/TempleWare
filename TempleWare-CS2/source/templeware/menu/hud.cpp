...
void Hud::render() {
    ...
    // WaterMark
    std::string watermarkText = "REDLINE | " + fpsStream.str() + " | " + timeBuffer;
    ...
    ImU32 bgColor = IM_COL32(18, 18, 18, 200);
    ImU32 borderColor = IM_COL32(217, 217, 217, 255);
    ImU32 textColor = IM_COL32(242, 242, 242, 255);
